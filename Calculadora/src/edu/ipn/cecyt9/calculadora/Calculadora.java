	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado *= new Double(pantalla.getText());
                        ...
                        numPantalla = new Double(pantalla.getText());
			resultado = Math.pow(resultado, numPantalla);
		} else if (operacion.equals("sen")) {
                        numPantalla = new Double(pantalla.getText());
			resultado = Math.sin(numPantalla);
		} else if (operacion.equals("log")) {
                        numPantalla = new Double(pantalla.getText());
			resultado = Math.log(numPantalla);
		} else if (operacion.equals("cos")) {
                        numPantalla = new Double(pantalla.getText());
			resultado = Math.cos(numPantalla);
		}
